...
if (IS_DIRECTORY ${SYS_SYSTEMD_DIR})
  ...
  if (EXISTS ${SYS_SYSTEMD_DIR}/${SUDODEVD_SERVICE} AND /usr STREQUAL ${CMAKE_INSTALL_PREFIX})
...
elseif (IS_DIRECTORY ${SYS_UPSTART_DIR})
  ...
  if (EXISTS ${SYS_UPSTART_DIR}/${SUDODEVD_CONF} AND /usr STREQUAL ${CMAKE_INSTALL_PREFIX})
...
elseif (IS_DIRECTORY ${SYS_SYSVINIT_DIR})
  ...
  if (EXISTS ${SYS_SYSVINIT_DIR}/${SUDODEVD} AND /usr STREQUAL ${CMAKE_INSTALL_PREFIX})
...
elseif (IS_DIRECTORY ${SYS_BSDINIT_DIR})
  ...
  if (EXISTS ${SYS_BSDINIT_DIR}/${RC_SUDODEVD} AND /usr STREQUAL ${CMAKE_INSTALL_PREFIX})
...
if (/usr STREQUAL ${CMAKE_INSTALL_PREFIX})
